...
# 2. Generating Annotations Sources
...
For each of the below annotations I need to generate GRCh38 versions. Annotations are stored in the root folder `annotations/hg38` with the corresponding name in brackets below:
...
* MPC scores [mpc]
** Have to lift this over the hg38
* PEXT scores [pext]
** Have to lift this over the hg38
...
* VEP annotations
* VQSR annotations
** For the purposes of UKBB this amounts to a 'fake' list of VQSR values for each variant that 
