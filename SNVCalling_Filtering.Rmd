...
*Note:* DO NOTE delete the raw files after you download them. VEP annotation requires them to work properly!
...
## Offline version:
## Obviously change the path if your local download:
...
2. Download each of the required files for hg38: [loftee hg38 ftp](https://personal.broadinstitute.org/konradk/loftee_data/GRCh38/)
** human ancestor
** sql database
** GERP database
