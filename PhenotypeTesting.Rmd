  ...
  for (s in c(1,2)) {
    ...
    for (modifier in seq(0,1,by=0.1)) {
      ...
      for (place in c("mid","lower","upper")) {
        ...
        ## I HAVE NO IDEA why I have to use as.character here. Something broken in data.table
...
```{r Supp Fig 9, fig.height=10, fig.width=8}
...
```{r Supp Fig 12, fig.height=15, fig.width=14}
